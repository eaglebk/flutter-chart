...
class SimplePrecisionTimeSeriesChart extends StatelessWidget {
  ...
  factory SimplePrecisionTimeSeriesChart.withSampleData() {
    return new SimplePrecisionTimeSeriesChart(
      _createSampleData(),
  ...
  factory SimplePrecisionTimeSeriesChart.withRandomData() {
    return new SimplePrecisionTimeSeriesChart(_createRandomData());
  }
  ...
  static List<charts.Series<TimeSeriesSales, DateTime>> _createSampleData() {
    final data = [
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 0, 0), 1),
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 1, 0), 2),
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 2, 0), 4),
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 3, 0), 3),
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 4, 0), 2),
      new TimeSeriesSales(new DateTime(2021, 3, 22, 15, 40, 0, 5, 0), 6),
    ];
